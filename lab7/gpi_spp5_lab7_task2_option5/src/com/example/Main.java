...
class Draw extends JComponent {
    ...
    public void paintComponent(Graphics g) {
        ...
        //paint
        g.drawPolygon(
        	new int[]{x1, x1, x2, x2, x1},
        	new int[]{y1, y2, y2, y1, y1},
        	5
        );
    ...
    public void paintMore(int n1, Graphics g,
    		double x1_1, double x2_1, double x3_1,
    		double y1_1, double y2_1, double y3_1) {
        ...
        g.drawPolygon(
        	new int[] {(int)x1, (int)x2, (int)x2_1, (int)x1},
            new int[] {(int)y1, (int)y2, (int)y2_1, (int)y1},
            4
        );
