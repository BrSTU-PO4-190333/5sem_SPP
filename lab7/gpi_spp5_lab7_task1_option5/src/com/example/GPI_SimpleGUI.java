...
public class GPI_SimpleGUI extends JFrame {
    ...
    protected int               gpi_height          = 460;          // Высота приложения
    protected int               gpi_x               = 0;            // Координата конца линии
    protected int               gpi_y               = 0;            // Координата конца линии
    protected int               gpi_r               = 200;          // Радиус (длина линии)
    protected int               gpi_t               = 100;          // Дедлайн для перерисовки
    protected int               gpi_s               = 8;            // Шаг по y
    protected Color             gpi_c               = Color.BLACK;  // Цвет линии
// = = = = = = = = = = = = = = = = = = = = = = = =
